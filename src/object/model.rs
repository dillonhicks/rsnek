...
//       fn $nfname(&$sel, rhs: &Builtin) -> NativeResult<$nativety>;
//    };
...
//       fn $nfname(&$sel, arg1: &Builtin, arg2: &Builtin) -> NativeResult<$nativety>;
//    };
...
//       fn $nfname(&$sel, arg1: &Builtin, arg2: &Builtin, arg3: &Builtin) -> NativeResult<$nativety>;
//    };
//    (variadic, $sel:ident, $pyname:ident, $tname:ident, $fname:ident, $nfname:ident) => {
//       fn $fname(&$sel, rt: &mut Runtime, args: &Vec<ObjectRef>) -> RuntimeResult;
//       fn $nfname(&$sel, rhs: &Vec<Builtin>) -> NativeResult<$nativety>;
//    }
//}
...
/// PyObject:
///
/// Trait defining all of the special methods common to all python objects.
/// see: https://docs.python.org/3/reference/datamodel.html#special-method-names
///
/// The convention for trait function handlers for __<name>__ methods is
/// op_<name> and native_<name> for the runtime and native api respectively.
/// While consistent, it is a convention and not a rule. The convention will be
/// broken as necessary in order to resolve name conflicts or for general implementation
/// clarity.
pub trait UrGH  {
...
api_method!(binary, self, __eq__, Equal, op_eq, native_eq, native::Boolean);
api_method!(binary, self, __ne__, NotEqual, op_ne, native_ne, native::Boolean);
...
api_method!(unary, self, __hash__, Hashable, op_hash, native_hash, native::HashId);

// Identity operators
api_method!(unary, self, identity, Identity, identity, native_identity, native::Boolean);
api_method!(unary, self, __bool__, Truth, op_bool, native_bool, native::Boolean);
api_method!(unary, self, __not__, Not, op_not, native_not, native::Boolean);
api_method!(binary, self, is_, Is, op_is, native_is, native::Boolean);
api_method!(binary, self, is_not, IsNot, op_is_not, native_is_not, native::Boolean);
...
// Defined in Identity: api_method!(unary, self, __bool__, Truth, op_bool, native_bool);
