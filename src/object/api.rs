...
//    fn identity(&self, runtime: &Runtime) -> RuntimeResult {
...
//    fn op_equals(&self, rt: &Runtime, rhs: &ObjectRef) -> RuntimeResult {
//        let rhs_builtin: &Box<Builtin> = rhs.0.borrow();
//
...
//    fn op_not_equals(&self, rt: &Runtime, rhs: &ObjectRef) -> RuntimeResult {
//        let rhs_builtin: &Box<Builtin> = rhs.0.borrow();
//
...
//        Ok(self.native_identity() == rhs.native_identity())
//    }
//
...
//{
//    fn op_hash(&self, &Runtime) -> RuntimeResult {
...
//    fn op_call(&self, &Runtime, &ObjectRef) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//}
//
...
//pub trait Container {
//    fn op_contains(&self, &Runtime, &ObjectRef) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//}
//
///// Iterable	 	__iter__
//pub trait Iterable {
//    fn op_iter(&self, &Runtime) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//}
//
...
//    fn _next(&self, &Runtime) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//}
//
...
//    fn op_reversed(&self, &Runtime) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//}
//
...
//    fn send(&self, &Runtime) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//
//    fn throw(&self, &Runtime) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//
//    fn close(&self, &Runtime) -> RuntimeResult {
//        Err(Error::not_implemented())
//    }
//}
//
